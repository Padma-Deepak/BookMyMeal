...
urlpatterns = [
    ...
    path('users/<uuid:pk>/set-password/', SetUserPasswordView.as_view(), name='set_user_password'),
    ...
    path('external-purchases/<uuid:pk>/', ExternalPurchaseDetailView.as_view(), name='external_purchase_detail'),

    # Vendors
    path('vendors/', VendorListView.as_view(), name='vendor_list'),
    path('vendors/<uuid:pk>/', VendorDetailView.as_view(), name='vendor_detail'),

    # Bills (guest-facing, uses customer_price)
    ...
    # Caterer bills (uses caterer_price)
    path('caterer-bills/', CatererBillListView.as_view(), name='caterer_bill_list'),
